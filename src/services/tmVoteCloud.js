...
export const seedMeetingOpsState = {
  attendance: [],
  roles: [
    { id: 'r1', roleName: '评论员 1', time: '3', personType: 'member', personId: '' },
    { id: 'r2', roleName: '评论员 2', time: '3', personType: 'member', personId: '' },
    { id: 'r3', roleName: '评论员 3', time: '3', personType: 'member', personId: '' },
    { id: 'r4', roleName: '即席主持人', time: '20', personType: 'member', personId: '' },
    { id: 'r5', roleName: '礼宾司', time: '3', personType: 'member', personId: '' },
    { id: 'r6', roleName: '会长', time: '5', personType: 'member', personId: '' },
    { id: 'r7', roleName: '例会主持人', time: '5', personType: 'member', personId: '' },
    { id: 'r8', roleName: '计时员', time: '3', personType: 'member', personId: '' },
    { id: 'r9', roleName: '尾音计算员', time: '3', personType: 'member', personId: '' },
    { id: 'r10', roleName: '语言评论员', time: '5', personType: 'member', personId: '' },
    { id: 'r11', roleName: '备稿讲员 1', time: '7', personType: 'member', personId: '' },
    { id: 'r12', roleName: '备稿讲员 2', time: '7', personType: 'member', personId: '' },
    { id: 'r13', roleName: '即席讲员 1', time: '2', personType: 'member', personId: '' },
    { id: 'r14', roleName: '即席讲员 2', time: '2', personType: 'member', personId: '' },
    { id: 'r15', roleName: '即席讲员 3', time: '2', personType: 'member', personId: '' },
    { id: 'r16', roleName: '即席讲员 4', time: '2', personType: 'member', personId: '' },
    { id: 'r17', roleName: '总评论', time: '10', personType: 'member', personId: '' },
    { id: 'r18', roleName: '技术经理', time: '15', personType: 'member', personId: '' },
    { id: 'r19', roleName: '登记与交流', time: '5', personType: 'member', personId: '' },
  ],
}
